        ...
        <section class='center'>
          <div class='container err'>
            ...
            <section class='err-section'>
              <div class='row'>
                <h1 style='margin-bottom: 50px;'>404: Page Not Found</h1><input type='button' class='color-btn' value='Home' onclick='window.location.href="/"' style='max-width: 40%;'>
              </div>
            </section>
        </section>
        </div>
