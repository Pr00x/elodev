      ...
      <div id='particles-js'>
        <section class='center'>
          <div class='container'>
            ...
            <section class='403-section'>
              <div class='row'>
                <h1 style='margin-bottom: 50px;'>403: Are you really trying to hack this platform?</h1><input type='button' class='color-btn' value='Home' onclick='window.location.href="/"' style='max-width: 40%;'>
              </div>
            </section>
        </section>
        </div>
